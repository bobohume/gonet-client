...
// int32 SocketId = 3;
inline void A_C_LoginResponse::clear_socketid() {
  socketid_ = 0;
}
inline ::google::protobuf::int32 A_C_LoginResponse::socketid() const {
  // @@protoc_insertion_point(field_get:message.A_C_LoginResponse.SocketId)
  return socketid_;
}
inline void A_C_LoginResponse::set_socketid(::google::protobuf::int32 value) {
  
  socketid_ = value;
  // @@protoc_insertion_point(field_set:message.A_C_LoginResponse.SocketId)
}
